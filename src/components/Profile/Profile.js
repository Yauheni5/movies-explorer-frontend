...
export default function Profile({
  ...
  function handleSubmit(e) {
    e.preventDefault();
    editDataUser({
      name: nameUser || userData.name,
      email: emailUser || userData.email,
    });
  }
    ...
    setIsValid(
      isValidNameUserInput &&
        ...
        ((nameUser !== userData.name && nameUser !== "") ||
          (emailUser !== userData.email && emailUser !== ""))
    );
    ...
    <section className="profile">
      <form className="profile__form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="profile__field profile__field_email">
          <p className="profile__field-title profile__field-title_email">
            E&#8209;mail
          </p>
          <input
